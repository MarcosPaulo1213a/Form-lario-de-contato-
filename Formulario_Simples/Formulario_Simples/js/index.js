function verificarCamposVazio(){
    const camposvazio = document.querySelectorAll(".campos");
...
function verificarNumero(){
    ...
    if( typeof numero === "string" && numero.length >0 && numero.length < 11 || numero.length >= 12){
  ...
  const  buttonEnviar = document.getElementById("btn").addEventListener("click", verificarCamposVazio);
